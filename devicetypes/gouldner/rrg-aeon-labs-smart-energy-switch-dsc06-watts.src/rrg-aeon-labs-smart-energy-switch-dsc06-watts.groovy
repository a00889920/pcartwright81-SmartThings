 ...
 *
 *  2015-08-18: Version 1.2.2 By: Ronald Gouldner
 *  Created version with different name for Watt reporting
 *  I may merge these two versions together to make a mW vs W option but not for now.
 *
 *  Developer's Notes
 ...
 */
metadata {
    definition (name: "RRG - Aeon Labs Smart Energy Switch-DSC06 WATTS", namespace: "gouldner", author: "James P") {
	capability "Switch"
	...
	details(["switch","power","energy","days","avgKW","energyTwo","reset","configure","refresh"])
    }
	...
	input "displayEvents", "boolean", 
        ...
        input "debugOutput", "boolean", 
                ...
                defaultValue: false, 
                displayDuringSetup: true
       input "kWhCost", "string", title: "\$/kWh (0.16)", defaultValue: "0.092" as String
    }
}
...
def zwaveEvent(physicalgraph.zwave.commands.meterv3.MeterReport cmd) {
    ...
    switch(cmd.scale) {
	    ...
	    previousValue = device.currentValue("energy") ?: cmd.scaledPreviousMeterValue ?: 0
            ...
            BigDecimal costDecimal = cmd.scaledMeterValue * ( kWhCost as BigDecimal) //taken from CDE Cost Website
